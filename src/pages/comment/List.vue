...
export default {
  ...
  methods:{
    loadData(){
      let url ="http://101.132.136.165:6677/comment/findAll"
    ...
    submitHandler(){
      ...
      let url = "http://101.132.136.165:6677/comment/saveOrUpdate";
      request({
        url,
        method:"POST",
        headers:{
    ...
    toDeleteHandler(id){
      this.$confirm('此操作将永久删除该文件, 是否继续?', '提示', {
        ...
        let url ="http://101.132.136.165:6677/comment/deleteById?id="+id;
        request.get(url).then((response)=>{
          this.loadData();
          this.$message({
                  type: 'success',
